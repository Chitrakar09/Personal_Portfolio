  ...
  return (
    <div id='container' className="max-h-full max-w-full min-h-full min-w-full flex justify-center items-center gap-10 px-10 flex-col lg:flex-row">
        ...
        <div id='info' className="text-text-light text-center flex flex-col items-center justify-center gap-1 ">
            ...
            <Link to="/realm/about"><Button text='Discover Me' className="p-4 text-lg md:text-2xl hidden lg:block mt-5 animate-fade animate-duration-[2000ms] animate-delay-1200 animate-ease-linear hover:bg-linear-[135deg,#00FFD1_0%,#FFD54A_100%] hover:-translate-y-1 transition-transform delay-100 ease-linear"/></Link>
        </div>
        <Link to="/realm/about"><Button text='Discover Me' className="p-4 text-lg md:text-2xl lg:hidden animate-fade animate-duration-[1500ms] animate-delay-1500 animate-ease-linear"/></Link>
    </div>
  )
}
