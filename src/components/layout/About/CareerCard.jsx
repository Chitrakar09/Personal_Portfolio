...
function CareerCard({
  ...
  return (
    ...
    >
      ...
      <div id="timeline">
        <h3 className={`font-extrabold text-start ${use==='experience'?'text-base tablet:text-xl smLaptop:text-xl laptop:text-xl lgLaptop:text-[1.2vw] 4k:text-4xl':'text-sm tablet:text-lg smLaptop:text-lg laptop:text-lg lgLaptop:text-[1.1vw] 4k:text-3xl/normal text-text-muted'}`}>
          {date}
        </h3>
      </div>
